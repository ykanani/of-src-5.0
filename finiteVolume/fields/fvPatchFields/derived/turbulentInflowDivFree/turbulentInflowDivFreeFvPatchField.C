...
#include "turbulentInflowDivFreeFvPatchField.H"
#include "clock.H"
...
template<class Type>
turbulentInflowDivFreeFvPatchField<Type>::turbulentInflowDivFreeFvPatchField
(
    const fvPatch& p,
...
turbulentInflowDivFreeFvPatchField<Type>::turbulentInflowDivFreeFvPatchField
(
    const turbulentInflowDivFreeFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
template<class Type>
void turbulentInflowDivFreeFvPatchField<Type>::autoMap
(
...
template<class Type>
void turbulentInflowDivFreeFvPatchField<Type>::rmap
(
...
)
{
    ...
    const turbulentInflowDivFreeFvPatchField<Type>& tiptf =
        refCast<const turbulentInflowDivFreeFvPatchField<Type> >(ptf);
...
template<class Type>
void turbulentInflowDivFreeFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void turbulentInflowDivFreeFvPatchField<Type>::write(Ostream& os) const
{
